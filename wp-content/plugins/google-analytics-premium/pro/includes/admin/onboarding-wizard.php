...
class MonsterInsights_Onboarding_Wizard_Pro {
	...
	public function is_code_installed_frontend() {
		...
		if ( 200 === wp_remote_retrieve_response_code( $request ) ) {
			...
			$cache_error = sprintf( esc_html__( '%1$sWe noticed you\'re using a caching plugin.%2$s Be sure to clear the cache to ensure the tracking appears on all pages and posts. %3$s(See this guide on how to clear cache)%4$s.', 'ga-premium' ), '<b>', '</b>', ' <a href="https://www.wpbeginner.com/beginners-guide/how-to-clear-your-cache-in-wordpress/" target="_blank">', '</a>' );
