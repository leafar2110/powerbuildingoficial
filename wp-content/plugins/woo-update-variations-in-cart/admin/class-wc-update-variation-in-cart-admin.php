...
class Wc_updateVariationInCartAdmin {
	...
	public function __construct() {
		...
		add_action( 'admin_head', array($this, 'woo_ck_wuvic_admin_global_js_vars' ));
	...
	public function woo_ck_wuvic_cart_variation_plugin_menu() {
		...
		add_options_page( __('Cart Variation Update','woocommerce-extension'), 
        	    ...
        	    __('Cart Variation Update','woocommerce-extension'), 'manage_options', 'woocommerce-edit-variation', array($this, 'woo_ck_wuvic_cart_variation_plugin_menu_option') );
				...
				<table class="form-table">
					...
					<tbody>
						...
						<tr>
							...
							<td><input name="WOO_CK_WUVIC_enable" type="checkbox" id="WOO_CK_WUVIC_enable" value="enable" <?php if("true" == get_option( 'WOO_CK_WUVIC_status' )){ echo 'checked'; } ?> >
	...
	public function add_action_links ( $links ) {
		...
		$mylinks = array( '<a href="' . admin_url( 'options-general.php?page=woocommerce-edit-variation' ) . '">Settings</a>',
