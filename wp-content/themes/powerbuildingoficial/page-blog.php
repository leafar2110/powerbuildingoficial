                    ...
                    <div class="col-md-8 col-sm-12 hidden-xs">
                        <div class="subnav">
                            ...
                            <ul class="nav nav-pills subnav-blog">
                                 <li><a href="#tab-todos" class="active" data-toggle="tab" role="tab" aria-controls="tab1" onclick="Activarentre();">Todos</a></li>  
                                 <li><a href="<?php bloginfo('url'); ?>/biografia" class="active">Biografias</a></li>  
                               <?php $i=0; ?>
                        ...
                        <div class="panel panel-default">
                          ...
                          <div id="collapse-menu-blog" class="panel-collapse collapse">
                              <ul class="nav subnav-blog">
                                 <li><a href="#tab-todos" class="active" data-toggle="tab" role="tab" aria-controls="tab1" onclick="Activarblog();">Todos</a></li>   
                                  <li><a href="#tab-biografia" class="active" data-toggle="tab" role="tab" aria-controls="tab1" onclick="Activarblog();">Biografia</a></li>  
                               <?php $i=0; ?>
                               <?php $categories =  get_categories("child_of=$id_cat");?>
                               <?php foreach($categories as $category): ?>
                               <?php $categoria = $category->name; ?> 
                        ...
                        <div class="search-blog">
                            <form class="navbar-form search-programs" id="ajax-form" method="post" action="">
                                <div class="form-group">
                                    <input  name="cat" id="cat" value="blog" class="form-control" type="hidden">
...
<div role="tabpanel" class="tab-pane in active" id="tab-todos">
...
<div role="tabpanel" class="tab-pane in " id="tab-biografia">
...
@media only screen and (max-width: 767px) {
 ...
 <?php
                           $argsBanner = array( 'post_type' => 'entrenador', 'post_per_page' => -1); 
...
$('#content').fadeOut(500, function(){ });//out the content area
$('#content').load(link + ' #content', function() { });
$('#content').fadeIn(500, function(){ });//in the content area
