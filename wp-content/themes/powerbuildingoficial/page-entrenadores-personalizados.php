                  ...
                  <div class="col-md-4 col-sm-6 col-xs-12">
                      <form class="navbar-form search-programs" id="ajax-form" method="post" action="">
                          <div class="form-group">
                              <input  name="cat" id="cat" value="entrenador_personalizado" class="form-control" type="hidden">
                    ...
                    <div id="tabContent1" class="tab-content">                     
                     ...
                     <div role="tabpanel" class="tab-pane fade in active" id="tab-todos">
                         ...
                         <?php
                           $argsBanner = array( 'post_type' => 'entrenador','posts_per_page' => 100, 'meta_key' => 'personalizados', 'meta_value' => 'Si' ); 
                     ...
                     <div role="tabpanel" class="tab-pane fade" id="tab-hombre">
                      ...
                      <div class="row content-hombre">
                        ...
                        <?php                        
                        $argsBanner = array( 'post_type' => 'entrenador', 'posts_per_page' => 100, 'category_name' => 'hombre', 'meta_key' => 'personalizados', 'meta_value' => 'Si' ); 
                        $Banners = new WP_Query($argsBanner);   
                        if ($Banners->have_posts()) : while($Banners->have_posts() ) : $Banners->the_post();  
                            $post_thumbnail_id = get_post_thumbnail_id( $Banners->id );  
                            $url = wp_get_attachment_url( $post_thumbnail_id);
                     ...
                     <div role="tabpanel" class="tab-pane fade" id="tab-mujer">
                      ...
                      <div class="row content-mujer">
                        <?php
                        $argsBanner = array( 'post_type' => 'entrenador', 'posts_per_page' => 100, 'category_name' => 'mujer', 'meta_key' => 'personalizados', 'meta_value' => 'Si' ); 
                        $Banners = new WP_Query($argsBanner);   
                        if ($Banners->have_posts()) : while($Banners->have_posts() ) : $Banners->the_post();  
                            $post_thumbnail_id = get_post_thumbnail_id( $Banners->id );  
                            $url = wp_get_attachment_url( $post_thumbnail_id);
...
<!-- ***********************SECTION WORKMODE*************************** -->
  <section id="workmode">
    <div
      class="workmode"
      style="background-image: url(https://powerbuildingoficial.com/wp-content/uploads/2019/09/bk-workmode-pbo.jpg)"
    >
      <div class="container">
        <div class="row">
          <div class="col-md-6 col-md-offset-6 col-sm-8 col-sm-offset-4">
            <div class="title-section text-left">
              ...
              <img
                ...
                alt=""
              />
              <h5>Atencion diaria por tu asesor vía WhatsApp.</h5>
              <br />
              <img
                class="icon-work-mode"
