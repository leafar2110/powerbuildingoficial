        ...
        >
          ...
          <div class="carousel-inner">
            ...
            <div
              ...
              style="background-image: url('https://powerbuildingoficial.com/wp-content/uploads/2020/09/bannerfinalposingmovil-scaled.jpg')"
            >
				
              <div class="carousel-caption">
                <p class="text-hashtag-white" style="font-size: 32px;">
                  <?php echo get_theme_mod('vota_banner1_titulo'); ?>
                </p>
                <h1 class="title-banner" style="font-size: 18px;">
...
<section id="voting">
    ...
    <div class="container">
            <div class="title-section text-center">
                    <h2>POSING PHYSIQUE WAR 🔥</h2>
                    <h6 class="text-link">Siguenos en Instagram para más retos <a href="https://www.instagram.com/powerbuilding_oficial/" target="blank">@powerbuilding_oficial</a></h6> 
            </div> 
              ...
              <form name="form">
                ...
                <div class="counter text-center container">
                    ...
                    <div class="days">
                       ...
                       <span >Muchas gracias por habernos acompañado hasta aquí, estáis ante los tres ganadores de sus correspondientes categorías, pero buscamos al ganador FINAL 👇</span>
                  ...
                  <div class="name-profile">
                    <p><?php the_author(); ?></p>
                     ...
                     <div class="content-img-post-item">
						<?php if (get_field('tipo_archivo_publicacion')=='Imagen'){  ?>
						   <img class="img-responsive" src="<?php echo $url_file2;?>" alt="">
                        <?php } ?>                        
                     </div>
                     <?php if (get_field('tipo_archivo_publicacion')=='Video'){  ?>
                        <video controlslist="nodownload" controls="none" playsinline="" preload autoplay loop muted width="100%" height="100%" class="" id="herovideoplayer-team"  src="<?php echo $url_file2;?>" alt="" type="video/mp4">
                        </video>
                     <?php } ?>					   
      ...
      ?>
          ...
          <a href="https://powerbuildingoficial.com/producto/boost-genetic-entrenamiento-en-casa/">
                <img class="img-responsive" src="<?php echo get_theme_mod('publicidad_imagen'); ?>" alt="" style="margin-top: 30px;">
            </a>
              </div>
              <div class="visible-xs col-xs-12">
          <a href="https://powerbuildingoficial.com/producto/boost-genetic-entrenamiento-en-casa/">
                <img class="img-responsive" src="https://powerbuildingoficial.com/wp-content/uploads/2020/05/publicidad-posts-movil-min.png" alt="" style="margin-top: 30px;">
            </a>
              </div>
                <!-- Post 2 -->
            <?php 
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  ...
                  <div class="name-profile">
                    <p><?php the_author(); ?></p>
                     ...
                     <?php if (get_field('tipo_archivo_publicacion')=='Video'){  ?>
                        <video controlslist="nodownload" controls="" playsinline="" preload autoplay loop muted width="100%" height="100%" class="" id="herovideoplayer-team"  src="<?php echo $url_file2;?>" alt="" type="video/mp4">
                        </video>
                     <?php } ?>
