...
$rocket_cookie_hash = 'fdd8eb49c18878ab2114c80a6e9bb57e';
$rocket_logged_in_cookie = 'wordpress_logged_in_fdd8eb49c18878ab2114c80a6e9bb57e';
$rocket_cache_mobile_files_tablet = 'desktop';
$rocket_cache_mobile = 1;
$rocket_do_caching_mobile_files = 1;
$rocket_cache_reject_uri = '/(.+/)?feed/?.+/?|/(?:.+/)?embed/|/finalizar-compra/(.*)|/carrito/|/mi-cuenta/(.*)|/wc-api/v(.*)|/(index\.php/)?wp\-json(/.*|$)|/powerbuildingmanager/';
...
$rocket_secret_cache_key = '5f5aeba66a2e5274585999';
$rocket_cache_ssl = 1;
